...
// EnumWindowByProcess ...
func (com *OpSoft) EnumWindowByProcess(processName, title, className string, filter int) string {
	ret, _ := com.op.CallMethod("EnumWindowByProcess", processName, title, className, filter)
	return ret.ToString()
}
...
// GetWindow ...
func (com *OpSoft) GetWindow(hwnd, flag int) int {
	ret, _ := com.op.CallMethod("GetWindow", hwnd, flag)
	return int(ret.Val)
}
